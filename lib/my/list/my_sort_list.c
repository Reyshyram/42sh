...
// Tell to my_sort_list_r that it should use adapt_cmp,
// storing the cmp function in the arg parameter
static int adapt_cmp(const void *a, const void *b, void *arg)
{
...
{
    return my_sort_list_r(head, adapt_cmp, (void *) cmp);
}
